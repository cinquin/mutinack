package contrib.net.sf.picard.analysis;
...
import contrib.net.sf.picard.metrics.PerUnitMetricCollector;
import contrib.net.sf.picard.metrics.SAMRecordAndReference;
import contrib.net.sf.picard.metrics.SAMRecordAndReferenceMultiLevelCollector;
import contrib.net.sf.picard.reference.ReferenceSequence;
import contrib.net.sf.picard.sam.ReservedTagConstants;
import contrib.net.sf.picard.util.Histogram;
            ...
            public void onComplete() {
                ...
                if (metrics.TOTAL_READS > 0)
                {
                    ...
                    if(doRefMetrics) {
                        ...
                        if (nonBisulfiteAlignedBases > 0) metrics.PF_MISMATCH_RATE = mismatchHistogram.getSum() / nonBisulfiteAlignedBases;
                        metrics.PF_HQ_MEDIAN_MISMATCHES = hqMismatchHistogram.getMedian();
                        if (hqNonBisulfiteAlignedBases > 0) metrics.PF_HQ_ERROR_RATE = hqMismatchHistogram.getSum() / hqNonBisulfiteAlignedBases;
