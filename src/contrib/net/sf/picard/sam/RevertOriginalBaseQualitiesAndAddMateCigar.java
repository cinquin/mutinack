...
public class RevertOriginalBaseQualitiesAndAddMateCigar extends CommandLineProgram {
    ...
    public int doWork() {
         ...
         */
        final PeekableIterator<SAMRecord> sorterIterator = new PeekableIterator<>(sorter.iterator());
        ...
        while (sorterIterator.hasNext()) {
            final List<SAMRecord> records = new LinkedList<>();
    ...
    public enum CanSkipSamFile {
        ...
        CanSkipSamFile(String format, boolean skip) {
            this.format = format;
            this.skip = skip;
        }
