...
public class BedReaderTest {
	...
	final BedReader bc = new BedReader(Arrays.asList(
		"chrI", "chrII", "chrIII", "chrIV", "chrM", "chrV", "chrX"), 
		new BufferedReader(new StringReader(bed)),
		"test reader", null);

	@Test
	public void test() throws ParseRTException {
		assertTrue(bc.test(new SequenceLocation(0, 6_028_500)));
		assertFalse(bc.test(new SequenceLocation(0, 6_028_499)));
		assertFalse(bc.test(new SequenceLocation(1, 6_028_500)));
		assertTrue(bc.test(new SequenceLocation(6, 7_824_630)));
		assertTrue(bc.test(new SequenceLocation(6, 7_824_631)));
		assertFalse(bc.test(new SequenceLocation(6, 7_825_216)));
		assertFalse(bc.test(new SequenceLocation(6, 0)));
		assertFalse(bc.test(new SequenceLocation(6, Integer.MAX_VALUE)));
		assertFalse(bc.test(new SequenceLocation(0, 0)));
	}
	...
	public void testFormat1() throws ParseRTException, IOException {
		...
		new BedReader(Arrays.asList(
			"chrI", "chrII", "chrIII", "chrIV", "chrM", "chrV", "chrX"), 
			new BufferedReader(new StringReader(bed1)),
			"test reader", null);
	...
	public void testFormat2() throws ParseRTException, IOException {
		...
		new BedReader(Arrays.asList(
			"chrI", "chrII", "chrIII", "chrIV", "chrM", "chrV", "chrX"), 
			new BufferedReader(new StringReader(bed2)),
			"test reader", null);
		throw new RuntimeException();
	}
	...
	public void testFormat3() throws ParseRTException, IOException {
		...
		new BedReader(Arrays.asList(
			"chrI", "chrII", "chrIII", "chrIV", "chrM", "chrV", "chrX"), 
			new BufferedReader(new StringReader(bed3)),
			"test reader", null);
		throw new RuntimeException();
	}
