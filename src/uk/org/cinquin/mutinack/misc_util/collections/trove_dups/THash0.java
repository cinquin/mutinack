 ...
 */
abstract public class THash0 implements Externalizable {
	...
	private int lastSizeAtCompaction1, lastSizeAtCompaction2, lastSizeAtCompaction3;
	 ...
	 */
	public THash0( int initialCapacity ) {
	 ...
	 */
	public THash0( int initialCapacity, float loadFactor ) {
		super();
	...
	public void compactToLargestOfLast3() {
		int targetCapacity = Math.max(_size, lastSizeAtCompaction1);
		targetCapacity = Math.max(targetCapacity, lastSizeAtCompaction2);
		targetCapacity = Math.max(targetCapacity, lastSizeAtCompaction3);
		lastSizeIndex += 1;
		if (lastSizeIndex == 3) {
			lastSizeIndex = 0;
		}
		switch (lastSizeIndex) {
			case 0:
				lastSizeAtCompaction1 = _size;
				break;
			case 1:
				lastSizeAtCompaction2 = _size;
				break;
			case 2:
				lastSizeAtCompaction3 = _size;
				break;
			default:
				throw new IllegalStateException();
		}
		compactToSize(targetCapacity);
	}
