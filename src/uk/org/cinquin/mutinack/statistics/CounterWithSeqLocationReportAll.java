 ...
 * @param <T>
 */
public class CounterWithSeqLocationReportAll<T> extends Counter<T> implements Serializable {

	private static final long serialVersionUID = 1472307547807376993L;

	public CounterWithSeqLocationReportAll(boolean sortByValue, MutinackGroup groupSettings) {
	...
	public CounterWithSeqLocationReportAll(MutinackGroup groupSettings) {
		this(false, groupSettings);
	}

	public void accept(SequenceLocation loc, @NonNull Object o) {
		super.acceptVarArgs(1d, o, loc.contigIndex, loc.position);
	}
}
